...
#define MV_E_LOAD_LIBRARY       0x8000000C      //Load library failed
#define MV_E_NOOUTBUF           0x8000000D      //No Avaliable Buffer
#define MV_E_UNKNOW             0x800000FF      //Unknown error

/********************************************************************/
#define MV_E_GC_GENERIC         0x80000100      //General error
#define MV_E_GC_ARGUMENT        0x80000101      //llegal parameters
...
#define MV_E_USB_DRIVER         0x80000305      //Driver mismatch or unmounted drive
